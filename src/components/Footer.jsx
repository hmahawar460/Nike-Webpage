    ...
    <div>
        <footer>
            <div className="mx-auto w-full max-w-6xl p-4 py-6 lg:py-8">
                ...
                <div className="mb-6 md:mb-0">
                    <Link to="/" className="flex items-center">
                        <img src={logo} className="h-12 me-1" alt="FlowBite Logo" />
                        <span className="text-heading self-center text-2xl font-semibold whitespace-nowrap nike-text">NI<span className='text-blue-500'>KE</span></span>
                    </Link>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-heading uppercase">Featured</h2>
                        <ul className="text-body font-medium">
                            <li className="mb-4">
                                <Link to="#" className="hover:underline ">Help Center</Link>
                            </li>
                            <li className="mb-4">
                                <Link to="#" className="hover:underline">Order Status</Link>
                            </li>
                            <li className="mb-4">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/" className="hover:underline">Nike, Inc.</a>. All Rights Reserved.
                </span>
                <div className="flex mt-4 sm:justify-center sm:mt-0">
                    ...
                    <Link to="#" className="text-body hover:text-heading ms-5">
